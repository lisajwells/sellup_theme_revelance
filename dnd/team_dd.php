	...
	if($style == 'style_1'){
		if(($social_links!='' && $social_under!=1) || $link!=''){
			$return .= '<div class="dnd_overlayed">
				<a class="dnd_team_member_link dnd_team_member_modal_link" href="'.$link.'"><img src="'.$image.'" alt="'.$name.'"></a>
			...
			$return.= '<a class="dnd_team_member_link dnd_team_member_modal_link" href="'.$link.'"><img src="'.$image.'" alt="'.$name.'"></a>';
		}
